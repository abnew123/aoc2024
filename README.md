...
On a 2024 MacBook Pro running macOS 15.6 (build 24G84), OpenJDK 23.0.1, `aarch64`, and 14 processors, the latest clean current-source 10-process means are 260.992 ms wall time and 187.805 ms summed solver time. The earlier clean counterbalanced comparison through Day 19 against pristine commit `88e8388` measured solver time improving from 207.398 ms to 186.258 ms (-10.19%); the paired 95% confidence interval for that solver delta is [-24.745, -17.536] ms.
