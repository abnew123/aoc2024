...
import src.solutions.SolverFactory;
...
public final class FreshJvmBenchmark {
    ...
    private static final int MEASURED_RUNS = measuredRuns();
    private static final String PROTOCOL_VERSION = "2";
    private static final double T_CRITICAL_95_DF_1 = 12.706205;
    ...
    private static int measuredRuns() {
        int runs = Integer.getInteger("aoc.benchmark.runs", 10);
        if (runs != 2 && runs != 10) {
            throw new IllegalArgumentException("aoc.benchmark.runs must be 2 or 10");
        }
        return runs;
    }
    ...
    private static void printComparison(String name, List<Sample> baseline,
        ...
        double critical = deltas.length == 2 ? T_CRITICAL_95_DF_1 : T_CRITICAL_95_DF_9;
        double halfWidth = critical * deltaStandardDeviation
